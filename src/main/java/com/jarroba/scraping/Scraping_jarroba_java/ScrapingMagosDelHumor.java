...
public class ScrapingMagosDelHumor {

	// http://leer-comics.blogspot.com/

	
	// magos del humor
	public static final String url = "https://leer-comics.blogspot.com/search?q=magos&x=0&y=0";
...
//	public static final String url = "http://leer-comics.blogspot.com/2019/12/robin-hijo-de-batman-1-1-6-usa.html#more";
	...
	public static final String dir_base_local = "c:/Magos del Humor";
	
	public static final String base_href_to_ignore = "https://leer-comics.blogspot.com/";

	public static final String contains1 = "leer-comics.blogspot.com";
	public static final String contains2 = "magos-del-humor-";
	
	public static final String reemplace = "magos-del-humor-";

	public static final int INICIO = 110;
	public static final int FIN = 200;
...
//			Elements entradas = documentParent.select("div.separator");
			...
			try {
				...
				for (Element elem : ahrefs) {
					...
					if (contador>INICIO && contador<FIN && !"".equals(href_html) && href_html.contains(".html") && href_html.contains(contains1) && href_html.contains(contains2)) {
						String directorios[]=href_html.substring(base_href_to_ignore.length()).replaceAll(".html", "").replaceAll("coleccion-ole-", "").split("/");
						System.out.println(titulo + " : " + href_html + "\n");
						
						String name_dir = dir_base_local;
						...
						if (generarPDF) {
							...
							if (!href_html.contains("https:")) {
								if (href_html.startsWith("//")) {
									href_html = "https:" + href_html;									
								} else {
									href_html = "https://" + href_html;		
								}
							}
							...
							for (Element elemento : ahrefs_comic) {
								...
								if (!"".equals(href) && (href.contains(".jpg") || href.contains(".JPG")) && href.contains("bp.blogspot.com")) {
									...
									href = href.replace("https://web.archive.org/web/20180410110013/", "");
